...
class AddOn extends GFPaymentAddOn
{
    ...
    public function feed_settings_fields(): array
    {
        return [
            [
                'fields' => [
                    [
                        ...
                        'class' => 'medium',
                        'required' => true,
                        'tooltip' => '<h6>' . esc_html__('Name', 'gravityforms') . '</h6>'
                                     . esc_html__(
                                         'Enter a feed name to uniquely identify this setup.',
                                         'gravityforms'
                                     ),
                    ],
                    [
                        ...
                        'tooltip' => '<h6>' . esc_html__('Transaction Type', 'gravityforms') . '</h6>'
                                     . esc_html__('Select a transaction type.', 'gravityforms'),
                    ],
                ],
            ],
            [
                ...
                'dependency' => [
                    ...
                    'values' => ['subscription', 'product', 'donation'],
                ],
                'fields' => $this->sage_pay_settings_fields(),
            ],
            [
                'title' => esc_html__('Products &amp; Services Settings', 'gravityforms'),
                'dependency' => [
                    'field' => 'transactionType',
                    'values' => ['product', 'donation'],
                ],
                'fields' => [
                    [
                        'name' => 'paymentAmount',
                        ...
                        'tooltip' => '<h6>' . esc_html__('Payment Amount', 'gravityforms') . '</h6>'
                                     . esc_html__(
                                         'Select which field determines the payment amount, or select'
                                         . " 'Form Total' to use the total of all pricing fields as the payment amount.",
                                         'gravityforms'
                                     ),
                    ],
                ],
            ...
            [
                'title' => esc_html__('Order Settings', 'gravityforms'),
                'dependency' => [
                    'field' => 'transactionType',
                    'values' => ['subscription', 'product', 'donation'],
                ],
                'fields' => $this->order_settings_fields(),
            ],
            [
                ...
                'fields' => [
                    [
                        ...
                        'type' => 'feed_condition',
                        'tooltip' => '<h6>' . esc_html__('Conditional Logic', 'gravityforms') . '</h6>'
                                     . esc_html__('When conditions are enabled, form submissions will only be sent to the'
                                                  . ' payment gateway when the conditions are met.'
                                                  . ' When disabled, all form submissions will be sent to the payment gateway.',
                                'gravityforms'),
                    ],
                ],
            ],
    ...
    private function order_settings_fields(): array
    {
        return [
            [
                ...
                'tooltip' => '<h6>' . esc_html__('Customer Information', 'gravityforms') . '</h6>'
                             . esc_html__(
                                 'Map your Form Fields to the available listed fields.',
                                 'gravityforms'
                             ),
            ],
            [
                ...
                'tooltip' => '<h6>' . esc_html__('Billing Information', 'gravityforms') . '</h6>'
                             . esc_html__(
                                 'Map your Form Fields to the available listed fields.',
                                 'gravityforms'
                             ),
            ...
            [
                ...
                'label' => esc_html__('Shipping Information', 'gravityforms'),
                'type' => 'field_map',
                'field_map' => $this->address_fields(),
                'tooltip' => '<h6>' . esc_html__('Shipping Information', 'gravityforms') . '</h6>'
                             . esc_html__(
                                 'Map your Form Fields to the available listed fields.',
                                 'gravityforms'
                             ),
    ...
    private function customer_info_fields(): array
    {
        return [
            ['name' => 'firstName', 'label' => esc_html__('First Name', 'gravityforms'), 'required' => true],
            ['name' => 'lastName', 'label' => esc_html__('Last Name', 'gravityforms'), 'required' => true],
            ['name' => 'email', 'label' => esc_html__('Email', 'gravityforms'), 'required' => false],
            ['name' => 'phone', 'label' => esc_html__('Phone', 'gravityforms'), 'required' => false],
        ];
    }
    ...
    {
        return [
            ['name' => 'address', 'label' => esc_html__('Address', 'gravityforms'), 'required' => true],
            ['name' => 'address2', 'label' => esc_html__('Address 2', 'gravityforms'), 'required' => false],
            ['name' => 'city', 'label' => esc_html__('City', 'gravityforms'), 'required' => true],
            ['name' => 'zip', 'label' => esc_html__('Zip', 'gravityforms'), 'required' => true],
            ['name' => 'country', 'label' => esc_html__('Country', 'gravityforms'), 'required' => true],
            ['name' => 'state', 'label' => esc_html__('State', 'gravityforms'), 'required' => false],
        ];
    }

    /**
     * TODO: Wrap `AbstractRequest` in adopters.
     *
     * @return array
     */
    private function sage_pay_settings_fields(): array
    {
        return [
            [
                'type' => 'text',
